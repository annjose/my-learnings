...
public final class CreateContactMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(createNetworkContact: CreateNetworkContact? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "createNetwork_Contact": createNetworkContact.flatMap { $0.snapshot }])
    }
    ...
    public struct CreateNetworkContact: GraphQLSelectionSet {
      ...
      public init(networkContactEdge: NetworkContactEdge? = nil) {
        self.init(snapshot: ["__typename": "CreateNetwork_ContactPayload", "networkContactEdge": networkContactEdge.flatMap { $0.snapshot }])
      }
      ...
      public struct NetworkContactEdge: GraphQLSelectionSet {
        ...
        public init(node: Node? = nil) {
          self.init(snapshot: ["__typename": "Network_ContactEdge", "node": node.flatMap { $0.snapshot }])
        }
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeNetwork_Contact(id: GraphQLID, entityVersion: String? = nil, displayName: String? = nil, person: Person? = nil, contactMethods: [ContactMethod?]? = nil) -> Node {
            return Node(snapshot: ["__typename": "Network_Contact", "id": id, "entityVersion": entityVersion, "displayName": displayName, "person": person.flatMap { $0.snapshot }, "contactMethods": contactMethods.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
          }
          ...
          public static func makeCompany_CompanyShareHolder(id: GraphQLID, entityVersion: String? = nil, displayName: String? = nil, person: Person? = nil, contactMethods: [ContactMethod?]? = nil) -> Node {
            return Node(snapshot: ["__typename": "Company_CompanyShareHolder", "id": id, "entityVersion": entityVersion, "displayName": displayName, "person": person.flatMap { $0.snapshot }, "contactMethods": contactMethods.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
          }
          ...
          public struct ContactMethod: GraphQLSelectionSet {
            ...
            public init(labels: [Network_Definitions_ContactMethodLabelEnum?]? = nil, emails: [Email?]? = nil, telephones: [Telephone?]? = nil, addresses: [Address?]? = nil) {
              self.init(snapshot: ["__typename": "Network_Definitions_ContactMethod", "labels": labels, "emails": emails.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "telephones": telephones.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "addresses": addresses.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
            }
            ...
            public struct Address: GraphQLSelectionSet {
              ...
              public init(freeFormAddressLine: String? = nil, addressFormatFormula: String? = nil, primary: Bool? = nil, active: Bool? = nil, formattedAddress: String? = nil, addressComponents: [AddressComponent?]? = nil) {
                self.init(snapshot: ["__typename": "Common_Address", "freeFormAddressLine": freeFormAddressLine, "addressFormatFormula": addressFormatFormula, "primary": primary, "active": active, "formattedAddress": formattedAddress, "addressComponents": addressComponents.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
              }
...
public final class CreateInvoiceMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(createTransactionsTransaction: CreateTransactionsTransaction? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "createTransactions_Transaction": createTransactionsTransaction.flatMap { $0.snapshot }])
    }
    ...
    public struct CreateTransactionsTransaction: GraphQLSelectionSet {
      ...
      public init(transactionsTransactionEdge: TransactionsTransactionEdge? = nil) {
        self.init(snapshot: ["__typename": "CreateTransactions_TransactionPayload", "transactionsTransactionEdge": transactionsTransactionEdge.flatMap { $0.snapshot }])
      }
      ...
      public struct TransactionsTransactionEdge: GraphQLSelectionSet {
        ...
        public init(node: Node? = nil) {
          self.init(snapshot: ["__typename": "Transactions_TransactionEdge", "node": node.flatMap { $0.snapshot }])
        }
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeTransactions_ReceivePayment(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_ReceivePayment", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_Bill(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_Bill", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_SalesReceipt(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_SalesReceipt", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_PurchaseOrder(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_PurchaseOrder", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_TransactionPurchase(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_TransactionPurchase", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_NonPostingCustomerCharge(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_NonPostingCustomerCharge", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_DelayedCredit(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_DelayedCredit", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_CreditCardCredit(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_CreditCardCredit", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_NonPostingCustomerCredit(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_NonPostingCustomerCredit", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_Estimate(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_Estimate", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_Purchase(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_Purchase", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_Template(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_Template", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_VendorCredit(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_VendorCredit", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_CreditMemo(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_CreditMemo", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_TimeCharge(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_TimeCharge", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_NonPostingReimbursableCharge(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_NonPostingReimbursableCharge", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_BillPayment(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_BillPayment", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_Charge(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_Charge", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_BankDeposit(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_BankDeposit", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_TransactionPurchaseSale(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_TransactionPurchaseSale", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_DelayedCharge(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_DelayedCharge", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_Transaction(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_Transaction", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_SalePrepaid(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_SalePrepaid", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_TransactionSales(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_TransactionSales", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_SaleRefund(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_SaleRefund", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_BankTransfer(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_BankTransfer", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_JournalEntry(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_JournalEntry", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_NonPostingTimeCharge(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_NonPostingTimeCharge", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_GeneralJournal(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_GeneralJournal", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public static func makeTransactions_Invoice(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) -> Node {
            return Node(snapshot: ["__typename": "Transactions_Invoice", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
          }
          ...
          public struct Line: GraphQLSelectionSet {
            ...
            public init(itemLines: ItemLine? = nil) {
              self.init(snapshot: ["__typename": "Transactions_Transaction_Lines", "itemLines": itemLines.flatMap { $0.snapshot }])
            }
            ...
            public struct ItemLine: GraphQLSelectionSet {
              ...
              public init(edges: [Edge?]? = nil) {
                self.init(snapshot: ["__typename": "Transactions_LineConnection", "edges": edges.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
              }
              ...
              public struct Edge: GraphQLSelectionSet {
                ...
                public init(node: Node? = nil) {
                  self.init(snapshot: ["__typename": "Transactions_LineEdge", "node": node.flatMap { $0.snapshot }])
                }
                ...
                public struct Node: GraphQLSelectionSet {
                  ...
                  public init(id: GraphQLID, amount: String? = nil, description: String? = nil, traits: Trait? = nil) {
                    self.init(snapshot: ["__typename": "Transactions_Line", "id": id, "amount": amount, "description": description, "traits": traits.flatMap { $0.snapshot }])
                  }
                  ...
                  public struct Trait: GraphQLSelectionSet {
                    ...
                    public init(item: Item? = nil) {
                      self.init(snapshot: ["__typename": "Transactions_Line_LineTraits", "item": item.flatMap { $0.snapshot }])
                    }
          ...
          public struct Trait: GraphQLSelectionSet {
            ...
            public init(delivery: Delivery? = nil, tracking: Tracking? = nil, balance: Balance? = nil, tax: Tax? = nil) {
              self.init(snapshot: ["__typename": "Transactions_Transaction_Traits", "delivery": delivery.flatMap { $0.snapshot }, "tracking": tracking.flatMap { $0.snapshot }, "balance": balance.flatMap { $0.snapshot }, "tax": tax.flatMap { $0.snapshot }])
            }
            ...
            public struct Tracking: GraphQLSelectionSet {
              ...
              public init(action: Transactions_Definitions_ActionEnum? = nil, trackerStatusInfo: [TrackerStatusInfo?]? = nil) {
                self.init(snapshot: ["__typename": "Transactions_Transaction_TrackingTrait", "action": action, "trackerStatusInfo": trackerStatusInfo.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
              }
          ...
          public struct Header: GraphQLSelectionSet {
            ...
            public init(txnDate: String? = nil, amount: String? = nil, txnStatus: Transactions_Transaction_TxnStatusEnum? = nil, label: String? = nil, referenceNumber: String? = nil, currencyInfo: CurrencyInfo? = nil, contact: Contact? = nil) {
              self.init(snapshot: ["__typename": "Transactions_Transaction_Header", "txnDate": txnDate, "amount": amount, "txnStatus": txnStatus, "label": label, "referenceNumber": referenceNumber, "currencyInfo": currencyInfo.flatMap { $0.snapshot }, "contact": contact.flatMap { $0.snapshot }])
            }
            ...
            public struct Contact: GraphQLSelectionSet {
              ...
              public static func makeNetwork_Contact(id: GraphQLID, displayName: String? = nil, person: Person? = nil, contactMethods: [ContactMethod?]? = nil) -> Contact {
                return Contact(snapshot: ["__typename": "Network_Contact", "id": id, "displayName": displayName, "person": person.flatMap { $0.snapshot }, "contactMethods": contactMethods.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
              }
              ...
              public static func makeCompany_CompanyShareHolder(id: GraphQLID, displayName: String? = nil, person: Person? = nil, contactMethods: [ContactMethod?]? = nil) -> Contact {
                return Contact(snapshot: ["__typename": "Company_CompanyShareHolder", "id": id, "displayName": displayName, "person": person.flatMap { $0.snapshot }, "contactMethods": contactMethods.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
              }
              ...
              public struct ContactMethod: GraphQLSelectionSet {
                ...
                public init(addresses: [Address?]? = nil) {
                  self.init(snapshot: ["__typename": "Network_Definitions_ContactMethod", "addresses": addresses.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
                }
...
public final class CreateServiceItemMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(createItemsServiceItem: CreateItemsServiceItem? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "createItems_ServiceItem": createItemsServiceItem.flatMap { $0.snapshot }])
    }
    ...
    public struct CreateItemsServiceItem: GraphQLSelectionSet {
      ...
      public init(itemsServiceItemEdge: ItemsServiceItemEdge? = nil) {
        self.init(snapshot: ["__typename": "CreateItems_ServiceItemPayload", "itemsServiceItemEdge": itemsServiceItemEdge.flatMap { $0.snapshot }])
      }
      ...
      public struct ItemsServiceItemEdge: GraphQLSelectionSet {
        ...
        public init(node: Node? = nil) {
          self.init(snapshot: ["__typename": "Items_ServiceItemEdge", "node": node.flatMap { $0.snapshot }])
        }
...
public final class CreateTripMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(createTripsTrip: CreateTripsTrip? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "createTrips_Trip": createTripsTrip.flatMap { $0.snapshot }])
    }
    ...
    public struct CreateTripsTrip: GraphQLSelectionSet {
      ...
      public init(tripsTripEdge: TripsTripEdge? = nil) {
        self.init(snapshot: ["__typename": "CreateTrips_TripPayload", "tripsTripEdge": tripsTripEdge.flatMap { $0.snapshot }])
      }
      ...
      public struct TripsTripEdge: GraphQLSelectionSet {
        ...
        public init(node: Node? = nil) {
          self.init(snapshot: ["__typename": "Trips_TripEdge", "node": node.flatMap { $0.snapshot }])
        }
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, description: String? = nil, startDateTime: StartDateTime? = nil, endDateTime: EndDateTime? = nil, startAddress: StartAddress? = nil, endAddress: EndAddress? = nil, distance: Distance? = nil, vehicle: Vehicle? = nil, notes: String? = nil, taxDeductionAmount: String? = nil, autoTracked: Bool? = nil, reviewState: Trips_Trip_TripReviewState? = nil) {
            self.init(snapshot: ["__typename": "Trips_Trip", "id": id, "description": description, "startDateTime": startDateTime.flatMap { $0.snapshot }, "endDateTime": endDateTime.flatMap { $0.snapshot }, "startAddress": startAddress.flatMap { $0.snapshot }, "endAddress": endAddress.flatMap { $0.snapshot }, "distance": distance.flatMap { $0.snapshot }, "vehicle": vehicle.flatMap { $0.snapshot }, "notes": notes, "taxDeductionAmount": taxDeductionAmount, "autoTracked": autoTracked, "reviewState": reviewState])
          }
          ...
          public struct StartAddress: GraphQLSelectionSet {
            ...
            public init(geoLocation: GeoLocation? = nil, addressComponents: [AddressComponent?]? = nil) {
              self.init(snapshot: ["__typename": "Common_Address", "geoLocation": geoLocation.flatMap { $0.snapshot }, "addressComponents": addressComponents.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
            }
...
public final class DeleteContactMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(updateNetworkContact: UpdateNetworkContact? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "updateNetwork_Contact": updateNetworkContact.flatMap { $0.snapshot }])
    }
    ...
    public struct UpdateNetworkContact: GraphQLSelectionSet {
      ...
      public init(networkContact: NetworkContact? = nil) {
        self.init(snapshot: ["__typename": "UpdateNetwork_ContactPayload", "networkContact": networkContact.flatMap { $0.snapshot }])
      }
...
public final class DeleteInvoiceMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(updateTransactionsTransaction: UpdateTransactionsTransaction? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "updateTransactions_Transaction": updateTransactionsTransaction.flatMap { $0.snapshot }])
    }
    ...
    public struct UpdateTransactionsTransaction: GraphQLSelectionSet {
      ...
      public init(clientMutationId: String, transactionsTransaction: TransactionsTransaction? = nil) {
        self.init(snapshot: ["__typename": "UpdateTransactions_TransactionPayload", "clientMutationId": clientMutationId, "transactionsTransaction": transactionsTransaction.flatMap { $0.snapshot }])
      }
...
public final class DeleteServiceItemMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(updateItemsItem: UpdateItemsItem? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "updateItems_Item": updateItemsItem.flatMap { $0.snapshot }])
    }
    ...
    public struct UpdateItemsItem: GraphQLSelectionSet {
      ...
      public init(clientMutationId: String, itemsItem: ItemsItem? = nil) {
        self.init(snapshot: ["__typename": "UpdateItems_ItemPayload", "clientMutationId": clientMutationId, "itemsItem": itemsItem.flatMap { $0.snapshot }])
      }
...
public final class GetCompanyInfoQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(company: Company? = nil) {
      self.init(snapshot: ["__typename": "Query", "company": company.flatMap { $0.snapshot }])
    }
    ...
    public struct Company: GraphQLSelectionSet {
      ...
      public init(companyInfo: CompanyInfo? = nil) {
        self.init(snapshot: ["__typename": "Company", "companyInfo": companyInfo.flatMap { $0.snapshot }])
      }
      ...
      public struct CompanyInfo: GraphQLSelectionSet {
        ...
        public init(companyName: String? = nil, logo: String? = nil, contactMethods: [ContactMethod?]? = nil, governmentIds: [GovernmentId?]? = nil) {
          self.init(snapshot: ["__typename": "Company_CompanyInfo", "companyName": companyName, "logo": logo, "contactMethods": contactMethods.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "governmentIds": governmentIds.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
        }
        ...
        public struct ContactMethod: GraphQLSelectionSet {
          ...
          public init(emails: [Email?]? = nil, addresses: [Address?]? = nil, telephones: [Telephone?]? = nil) {
            self.init(snapshot: ["__typename": "Network_Definitions_ContactMethod", "emails": emails.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "addresses": addresses.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "telephones": telephones.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
          }
          ...
          public struct Address: GraphQLSelectionSet {
            ...
            public init(formattedAddress: String? = nil, addressComponents: [AddressComponent?]? = nil, primary: Bool? = nil, active: Bool? = nil) {
              self.init(snapshot: ["__typename": "Common_Address", "formattedAddress": formattedAddress, "addressComponents": addressComponents.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "primary": primary, "active": active])
            }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Company: GraphQLSelectionSet {
      ...
      public init(settings: Setting? = nil) {
        self.init(snapshot: ["__typename": "Company", "settings": settings.flatMap { $0.snapshot }])
      }
      ...
      public struct Setting: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, qboAppData: QboAppDatum? = nil, localizationPrefs: LocalizationPref? = nil) {
          self.init(snapshot: ["__typename": "Company_Settings", "id": id, "qboAppData": qboAppData.flatMap { $0.snapshot }, "localizationPrefs": localizationPrefs.flatMap { $0.snapshot }])
        }
        ...
        public struct QboAppDatum: GraphQLSelectionSet {
          ...
          public init(companyInfoAppData: CompanyInfoAppDatum? = nil) {
            self.init(snapshot: ["__typename": "Company_Definitions_SettingsAppData", "companyInfoAppData": companyInfoAppData.flatMap { $0.snapshot }])
          }
          ...
          public struct CompanyInfoAppDatum: GraphQLSelectionSet {
            ...
            public struct CompanyAddress: GraphQLSelectionSet {
              ...
              public init(addressComponents: [AddressComponent?]? = nil) {
                self.init(snapshot: ["__typename": "Common_Address", "addressComponents": addressComponents.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
              }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Company: GraphQLSelectionSet {
      ...
      public init(contacts: Contact? = nil) {
        self.init(snapshot: ["__typename": "Company", "contacts": contacts.flatMap { $0.snapshot }])
      }
      ...
      public struct Contact: GraphQLSelectionSet {
        ...
        public init(edges: [Edge?]? = nil) {
          self.init(snapshot: ["__typename": "Network_ContactConnection", "edges": edges.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
        }
        ...
        public struct Edge: GraphQLSelectionSet {
          ...
          public struct Node: GraphQLSelectionSet {
            ...
            public static func makeNetwork_Contact(id: GraphQLID, entityVersion: String? = nil, displayName: String? = nil, contactMethods: [ContactMethod?]? = nil) -> Node {
              return Node(snapshot: ["__typename": "Network_Contact", "id": id, "entityVersion": entityVersion, "displayName": displayName, "contactMethods": contactMethods.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
            }
            ...
            public static func makeCompany_CompanyShareHolder(id: GraphQLID, entityVersion: String? = nil, displayName: String? = nil, contactMethods: [ContactMethod?]? = nil) -> Node {
              return Node(snapshot: ["__typename": "Company_CompanyShareHolder", "id": id, "entityVersion": entityVersion, "displayName": displayName, "contactMethods": contactMethods.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
            }
            ...
            public struct ContactMethod: GraphQLSelectionSet {
              ...
              public init(primary: Bool? = nil, active: Bool? = nil, emails: [Email?]? = nil, telephones: [Telephone?]? = nil, addresses: [Address?]? = nil) {
                self.init(snapshot: ["__typename": "Network_Definitions_ContactMethod", "primary": primary, "active": active, "emails": emails.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "telephones": telephones.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "addresses": addresses.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
              }
...
public final class GetInvoiceQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(node: Node? = nil) {
      self.init(snapshot: ["__typename": "Query", "node": node.flatMap { $0.snapshot }])
    }
    ...
    public struct Node: GraphQLSelectionSet {
      ...
      public struct AsTransactionsTransaction: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, entityVersion: String? = nil, meta: Metum? = nil, lines: Line? = nil, traits: Trait? = nil, header: Header? = nil) {
          self.init(snapshot: ["__typename": "Transactions_Transaction", "id": id, "entityVersion": entityVersion, "meta": meta.flatMap { $0.snapshot }, "lines": lines.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }, "header": header.flatMap { $0.snapshot }])
        }
          ...
          public struct Contact: GraphQLSelectionSet {
            ...
            public struct ContactMethod: GraphQLSelectionSet {
              ...
              public init(emails: [Email?]? = nil, addresses: [Address?]? = nil) {
                self.init(snapshot: ["__typename": "Network_Definitions_ContactMethod", "emails": emails.flatMap { $0.map { $0.flatMap { $0.snapshot } } }, "addresses": addresses.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
              }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Company: GraphQLSelectionSet {
      ...
      public init(transactions: Transaction? = nil) {
        self.init(snapshot: ["__typename": "Company", "transactions": transactions.flatMap { $0.snapshot }])
      }
      ...
      public struct Transaction: GraphQLSelectionSet {
        ...
        public init(edges: [Edge?]? = nil) {
          self.init(snapshot: ["__typename": "Transactions_TransactionConnection", "edges": edges.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
        }
        ...
        public struct Edge: GraphQLSelectionSet {
          ...
          public struct Node: GraphQLSelectionSet {
            ...
            public static func makeTransactions_ReceivePayment(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_ReceivePayment", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_Bill(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_Bill", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_SalesReceipt(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_SalesReceipt", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_PurchaseOrder(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_PurchaseOrder", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_TransactionPurchase(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_TransactionPurchase", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_NonPostingCustomerCharge(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_NonPostingCustomerCharge", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_DelayedCredit(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_DelayedCredit", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_CreditCardCredit(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_CreditCardCredit", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_NonPostingCustomerCredit(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_NonPostingCustomerCredit", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_Estimate(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_Estimate", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_Purchase(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_Purchase", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_Template(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_Template", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_VendorCredit(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_VendorCredit", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_CreditMemo(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_CreditMemo", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_TimeCharge(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_TimeCharge", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_NonPostingReimbursableCharge(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_NonPostingReimbursableCharge", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_BillPayment(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_BillPayment", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_Charge(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_Charge", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_BankDeposit(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_BankDeposit", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_TransactionPurchaseSale(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_TransactionPurchaseSale", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_DelayedCharge(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_DelayedCharge", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_Transaction(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_Transaction", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_SalePrepaid(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_SalePrepaid", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_TransactionSales(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_TransactionSales", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_SaleRefund(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_SaleRefund", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_BankTransfer(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_BankTransfer", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_JournalEntry(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_JournalEntry", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_NonPostingTimeCharge(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_NonPostingTimeCharge", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_GeneralJournal(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_GeneralJournal", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public static func makeTransactions_Invoice(id: GraphQLID, entityVersion: String? = nil, type: Transactions_Definitions_TransactionTypeEnum? = nil, header: Header? = nil, traits: Trait? = nil) -> Node {
              return Node(snapshot: ["__typename": "Transactions_Invoice", "id": id, "entityVersion": entityVersion, "type": type, "header": header.flatMap { $0.snapshot }, "traits": traits.flatMap { $0.snapshot }])
            }
            ...
            public struct Header: GraphQLSelectionSet {
              ...
              public init(referenceNumber: String? = nil, txnDate: String? = nil, contact: Contact? = nil, currencyInfo: CurrencyInfo? = nil, amount: String? = nil, txnStatus: Transactions_Transaction_TxnStatusEnum? = nil) {
                self.init(snapshot: ["__typename": "Transactions_Transaction_Header", "referenceNumber": referenceNumber, "txnDate": txnDate, "contact": contact.flatMap { $0.snapshot }, "currencyInfo": currencyInfo.flatMap { $0.snapshot }, "amount": amount, "txnStatus": txnStatus])
              }
            ...
            public struct Trait: GraphQLSelectionSet {
              ...
              public init(tracking: Tracking? = nil, balance: Balance? = nil) {
                self.init(snapshot: ["__typename": "Transactions_Transaction_Traits", "tracking": tracking.flatMap { $0.snapshot }, "balance": balance.flatMap { $0.snapshot }])
              }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Company: GraphQLSelectionSet {
      ...
      public init(serviceItems: ServiceItem? = nil) {
        self.init(snapshot: ["__typename": "Company", "serviceItems": serviceItems.flatMap { $0.snapshot }])
      }
      ...
      public struct ServiceItem: GraphQLSelectionSet {
        ...
        public init(edges: [Edge?]? = nil) {
          self.init(snapshot: ["__typename": "Items_ServiceItemConnection", "edges": edges.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
        }
...
public final class UpdateCompanyInfoFromSettingsMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(updateCompanySettings: UpdateCompanySetting? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "updateCompany_Settings": updateCompanySettings.flatMap { $0.snapshot }])
    }
    ...
    public struct UpdateCompanySetting: GraphQLSelectionSet {
      ...
      public init(companySettings: CompanySetting? = nil) {
        self.init(snapshot: ["__typename": "UpdateCompany_SettingsPayload", "companySettings": companySettings.flatMap { $0.snapshot }])
      }
    ...
    public struct UpdateNetworkContact: GraphQLSelectionSet {
      ...
      public struct NetworkContact: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, entityVersion: String? = nil, displayName: String? = nil, person: Person? = nil, contactMethods: [ContactMethod?]? = nil) {
          self.init(snapshot: ["__typename": "Network_Contact", "id": id, "entityVersion": entityVersion, "displayName": displayName, "person": person.flatMap { $0.snapshot }, "contactMethods": contactMethods.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
        }
    ...
    public struct UpdateTransactionsTransaction: GraphQLSelectionSet {
      ...
      public struct TransactionsTransaction: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, entityVersion: String? = nil, header: Header? = nil) {
          self.init(snapshot: ["__typename": "Transactions_Transaction", "id": id, "entityVersion": entityVersion, "header": header.flatMap { $0.snapshot }])
        }
        ...
        public struct Header: GraphQLSelectionSet {
          ...
          public init(referenceNumber: String? = nil, txnDate: String? = nil, amount: String? = nil, txnStatus: Transactions_Transaction_TxnStatusEnum? = nil, contact: Contact? = nil) {
            self.init(snapshot: ["__typename": "Transactions_Transaction_Header", "referenceNumber": referenceNumber, "txnDate": txnDate, "amount": amount, "txnStatus": txnStatus, "contact": contact.flatMap { $0.snapshot }])
          }
...
public final class UpdateServiceItemMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(updateItemsServiceItem: UpdateItemsServiceItem? = nil) {
      self.init(snapshot: ["__typename": "Mutation", "updateItems_ServiceItem": updateItemsServiceItem.flatMap { $0.snapshot }])
    }
    ...
    public struct UpdateItemsServiceItem: GraphQLSelectionSet {
      ...
      public init(itemsServiceItem: ItemsServiceItem? = nil) {
        self.init(snapshot: ["__typename": "UpdateItems_ServiceItemPayload", "itemsServiceItem": itemsServiceItem.flatMap { $0.snapshot }])
      }
