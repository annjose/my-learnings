...
public final class AllPostsQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(posts: [Post?]? = nil) {
      self.init(snapshot: ["__typename": "Query", "posts": posts.flatMap { $0.map { $0.flatMap { $0.snapshot } } }])
    }
    ...
    public struct Post: GraphQLSelectionSet {
      ...
      public init(id: Int, title: String? = nil, votes: Int? = nil, author: Author? = nil) {
        self.init(snapshot: ["__typename": "Post", "id": id, "title": title, "votes": votes, "author": author.flatMap { $0.snapshot }])
      }
